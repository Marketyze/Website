    ...
    return (
        ...
        <HeroContainer>
            ...
            <HeroH1>
                Programs
                <HeroP>
                    Experience the workflow of a professional 
                </HeroP>
            </HeroH1>

             {/** mouse scrolling animation */}
             <div id="mouse-scrollPrograms">
                    <div class="mousePrograms">
                        <div class="mouse-inPrograms"></div>
                    </div>
            </div>
